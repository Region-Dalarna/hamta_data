hamta_bef_forandringar_region_forandringar_kon_tid_scb <- function(
			...
			filnamn_excelfil = "bef_forandringar.xlsx",			# filnamn för excelfil som exporteras om filnamn_excelfil och mapp_excelfil anges
  ...
  #
  # Skapad av: moepet den 19 maj 2025, och ersätter tidigare skript med samma namn, men nu med nya CKM-tabellen så vi sätter
  #            ihop data från båda tabellerna i en och samma dataframe, dvs data från och med år 2025 med data från tidigare år
  #
  # Senast uppdaterad: 19 maj 2025
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__BE__BE0101__BE0101G/ManadBefStatRegion/
  #												https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__BE__BE0101__BE0101G/MBefStatRegionCKM/
  #
  # ====================================================================================================
 ...
 hamta_data <- function(url_uttag) {
  ...
  forandringar_vekt <- hamta_kod_med_klartext(px_meta, befforandr_klartext, skickad_fran_variabel = "forandringar")
