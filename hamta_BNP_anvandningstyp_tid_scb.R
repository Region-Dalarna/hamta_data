hamta_BNP_anvandningstyp_tid_scb <- function(
			anvandningstyp_klartext = "*",			 #  Finns: "- BNP till marknadspris", "- Import av varor och tjänster", "-- import av varor", "-- import av tjänster", "- Konsumtionsutgifter", "-- hushållens konsumtionsutgifter; inkl icke-vinstdrivande organisationer", "--- de egentliga hushållens konsumtion", "--- hushållens icke vinstdrivande organisationers konsumtion", "-- offentliga konsumtionsutgifter", "--- statliga myndigheters konsumtionsutgifter", "--- kommunala myndigheters konsumtionsutgifter", "---- primärkommunernas konsumtionsutgifter", "---- regionernas konsumtionsutgifter", "- Bruttoinvesteringar", "-- fast bruttoinvestering", "-- lagerinvesteringar inkl. värdeföremål", "--- lagerinvesteringar", "--- investering i värdeföremål", "- Export av varor och tjänster", "-- export av varor", "-- export av tjänster", "- Inhemsk slutlig användning exkl. lagerinvesteringar", "- Inhemsk slutlig användning", "Summa slutlig användning exkl. lagerinvesteringar", "Summa slutlig användning"
			cont_klartext = "*",			 #  Finns: "Säsongrensad, löpande priser, mnkr", "Säsongrensad, fasta priser referensår 2022, mnkr", "Säsongrensad, volymförändring föregående period, procent"
  ...
  #
  # url till tabellens API: https://api.scb.se/OV0104/v1/doris/sv/ssd/START/NR/NR0103/NR0103B/NR0103ENS2010T10SKv
  #
  # ====================================================================================================
  ...
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/NR/NR0103/NR0103B/NR0103ENS2010T10SKv"
  ...
  anvandningstyp_vekt <- hamta_kod_med_klartext(px_meta, anvandningstyp_klartext, skickad_fran_variabel = "anvandningstyp")
  ...
  varlista <- list(
  "Anvandningstyp" = anvandningstyp_vekt,
