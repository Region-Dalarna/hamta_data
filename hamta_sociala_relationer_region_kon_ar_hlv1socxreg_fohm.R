hamta_sociala_relationer_region_kon_ar_fohm <- function(
  ...
  #
  # Skapad av: frkjon den 18 december 2024
  # Senast uppdaterad: 18 december 2024
  #
  # url till tabellens API: https://fohm-app.folkhalsomyndigheten.se/Folkhalsodata/api/v1/sv/A_Folkhalsodata/B_HLV/eSocialarel/aSocialarel/hlv1socxreg.px
  #
  # ====================================================================================================
  ...
  url_uttag <- "https://fohm-app.folkhalsomyndigheten.se/Folkhalsodata/api/v1/sv/A_Folkhalsodata/B_HLV/eSocialarel/aSocialarel/hlv1socxreg.px"
