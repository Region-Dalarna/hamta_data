hamta_hlv_halsa_riket_halsotillstand_andel_och_konfidensintervall_alder_kon_ar_fohm <- function(
			halsotillstand_klartext = "*",			 #  Finns: "Bra eller mycket bra hälsa", "Dålig eller mycket dålig hälsa", "Långvarig sjukdom", "Nöjd med sexlivet"
			...
			ålder_klartext = "*",			 #  Finns: "Totalt 16- år", "Totalt 16-84 år", "16-29 år", "30-44 år", "45-64 år", "65-84 år", "85- år"
			...
			excel_filnamn = "hlv_halsa_riket.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # Skapad av: moepet den 14 april 2025
  # Senast uppdaterad: 14 april 2025
  #
  # url till tabellens API: https://fohm-app.folkhalsomyndigheten.se/Folkhalsodata/pxweb/sv/A_Folkhalsodata/A_Folkhalsodata__B_HLV__bFyshals__bbaFyshalsallman/hlv1allmaald.px/
  #
  # ====================================================================================================
  ...
  # Url till databas
  url_uttag <- "https://fohm-app.folkhalsomyndigheten.se/Folkhalsodata/api/v1/sv/A_Folkhalsodata/B_HLV/bFyshals/bbaFyshalsallman/hlv1allmaald.px"
