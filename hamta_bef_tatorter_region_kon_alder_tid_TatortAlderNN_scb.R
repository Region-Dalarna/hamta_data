hamta_bef_tatorter_region_kon_alder_tid_scb <- function(
			region_vekt = "*",			   # Val av region. Finns: t.ex. "0127TB106", "0160TB101", "0885TB122", "1080TB142"
			kon_klartext = "totalt",			 #  Finns: "totalt", "kvinnor", "män"
			alder_klartext = "totalt",			 #  NA = tas inte med i uttaget,  Finns: "0-19 år", "20-64 år", "65+ år", "totalt"
			cont_klartext = "*",			 #  Finns: "Antal"
			tid_koder = "*",			 # "*" = alla år eller månader, "9999" = senaste, finns: "2005", "2010", "2015", "2020", "2023"
			output_mapp = NA,			# anges om man vill exportera en excelfil med uttaget, den mapp man vill spara excelfilen till
			excel_filnamn = "bef_tatorter.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__MI__MI0810__MI0810A/TatortAlderNN/
  #
  # ====================================================================================================
  ...
  # Url till databas
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/MI/MI0810/MI0810A/TatortAlderNN"
  px_meta <- pxweb_get(url_uttag)

  varlist_koder <- pxvarlist(px_meta)$koder
  varlist_bada <- pxvarlist(px_meta)
  
  # speciallösning för tätorter så att man kan hämta tätorter från hela län, kommuner eller specifika tätorter
  alla_regionkoder <- hamta_giltiga_varden_fran_tabell(px_meta, "region") 
  if (!("*" %in% region_vekt)) {
    # här delar vi upp de medskickade regionkoderna i Tätortskoder, länskoder och kommunkoder 
    ...
    # här hämtar vi alla tätorter för de länskoder eller kommunkoder som skickats med
    ...
    # vi lägger ihop vektorerna för färdiga tätorter, samt tätorter för de län och kommuner som skickats med samt tar bort dubletter
