hamta_yrke_region_rams_bas_sni2007_kon_tid_scb <- function(
			...
			sni2007_klartext = "*",			 #  NA = tas inte med i uttaget,  Finns: "jordbruk, skogsbruk och fiske", "tillverkning och utvinning", "energiförsörjning; miljöverksamhet", "byggverksamhet", "handel", "transport och magasinering", "hotell- och restaurangverksamhet", "information och kommunikation", "finans- och försäkringsverksamhet", "fastighetsverksamhet", "företagstjänster", "offentlig förvaltning och försvar", "utbildning ", "vård och omsorg; sociala tjänster", "kulturella och personliga tjänster m.m.", "okänd verksamhet"
			...
			tid_koder = "*",			 # "*" = alla år eller månader, "9999" = senaste, finns: "2014", "2015", "2016", "2017", "2018"
  ...
  #
  # Skapad av: moepet den 30 augusti 2024
  # Senast uppdaterad: 30 augusti 2024
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__AM__AM0208__AM0208D/YREG56/
  #												https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__AM__AM0208__AM0208D/YREG56N/
  ...
  url_list <- c("https://api.scb.se/OV0104/v1/doris/sv/ssd/START/AM/AM0208/AM0208D/YREG56",
						"https://api.scb.se/OV0104/v1/doris/sv/ssd/START/AM/AM0208/AM0208D/YREG56N",
						"https://api.scb.se/OV0104/v1/doris/sv/ssd/START/AM/AM0208/AM0208D/YREG56BAS")
 ...
 hamta_data <- function(url_uttag) {
  ...
  var_vektor <- c(regionkod = "Region", yrkeskod = "Yrke2012", branschkod = "SNI2007")
  var_vektor_klartext <- c("region", "Yrke (SSYK 2012)", "näringsgren SNI 2007")
