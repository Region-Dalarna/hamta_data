hamta_matchningsgrad_region_utbildning_konalderfodelseland_tid_scb <- function(
    ...
    tid_koder = "*",			 # "*" = alla år eller månader, "9999" = senaste, finns: "2015", "2016", "2017", "2018", "2019", "2020", "2021"
  ...
  konalderfodelseland_vekt <- hamta_kod_med_klartext(px_meta, konalderfodelseland_klartext, "KonAlderFodelseland")
  ...
  if (all(is.na(utbildning_klartext))) varlista <- varlista[names(varlista) != "Utbildning"]
