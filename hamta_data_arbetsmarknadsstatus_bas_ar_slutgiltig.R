hamta_arbetsmarknadsstatus_bas_ar_slutgiltig <- function(
  ...
  # Innehåller slutgiltig data för arbetsmarknadsstatus baserat på ålder, kön, födelseregion, region och år.
  # Automatgenererat av en funktion i R som skrivits av Peter Möller, Region Dalarna
  #
  # Skapad av: frkjon den 05 mars 2024
  # Senast uppdaterad: 05 mars 2024
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__AM__AM0210__AM0210D/ArRegArbStatus/
  #
  # ====================================================================================================
  ...
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/AM/AM0210/AM0210D/ArRegArbStatus"
