hamta_konkurser_manad_lan_variabel_tva <- function(
  ...
  url_uttag <- "https://statistik.tillvaxtanalys.se:443/PxWeb/api/v1/sv/Tillväxtanalys statistikdatabas/Konkurser och offentliga ackord/konkurser_manad_lan.px"
