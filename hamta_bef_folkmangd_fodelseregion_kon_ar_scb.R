hamta_bef_folkmangd_fodelseregion_kon_ar_scb <- function(
    ...
    excel_filnamn = "folkmangd_fodelseregion.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # Skapad av: frkjon den 07 juni 2024
