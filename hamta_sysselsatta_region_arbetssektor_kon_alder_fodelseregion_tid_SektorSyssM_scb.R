hamta_sysselsatta_region_arbetssektor_kon_alder_fodelseregion_tid_scb <- function(
    ...
    arbetssektor_klartext = "*",			 #  Finns: "samtliga sektorer", "näringslivet", "hushållens icke-vinstdrivande organisationer", "staten", "kommun", "region", "offentlig förvaltning (staten, kommun, region)", "övrigt"
    kon_klartext = "*",			 #  NA = tas inte med i uttaget,  Finns: "män", "kvinnor", "totalt"
    alder_klartext = "*",			 #  Finns: "15-24 år", "25-54 år", "55-74 år", "15-74 år", "16-64 år", "20-64 år", "16-65 år", "20-65 år"
    ...
    excel_filnamn = "sysselsatta_sektor.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # Skapad av: frkjon den 14 november 2024
  ...
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/AM/AM0210/AM0210B/SektorSyssM"
  ...
  arbetssektor_vekt <- hamta_kod_med_klartext(px_meta, arbetssektor_klartext, skickad_fran_variabel = "arbetssektor")
  ...
  var_vektor <- c(regionkod = "Region", arbetssektorkod = "ArbetsSektor")
  var_vektor_klartext <- c("region", "arbetsställets sektortillhörighet")
