hamta_sysselsatta_region_kon_sni2007_utbildningsniva_tid_scb <- function(
    ...
    utbildningsniva_klartext = "*",			 #  Finns: "förgymnasial utbildning", "gymnasial utbildning, högst 2 år", "gymnasial utbildning, 3 år", "eftergymnasial utbildning, mindre än 3 år", "eftergymnasial utbildning 3 år eller längre inkl. forskarutbildning", "uppgift om utbildningsnivå saknas"
  ...
  #
  # Skapad av: frkjon den 10 januari 2025
  # Senast uppdaterad: 10 januari 2025
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__AM__AM0210__AM0210F/ArRegUtb/
  #
  # ====================================================================================================
  ...
  # Url till databas
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/AM/AM0210/AM0210F/ArRegUtb"
