hamta_hushall_region_hushallstyp_boendeform_tid_scb <- function(
			...
			hushallstyp_klartext = "*",			 #  NA = tas inte med i uttaget,  Finns: "ensamstående kvinnor -64 år utan barn", "ensamstående kvinnor 65- år utan barn", "ensamstående män -64 år utan barn", "ensamstående män 65- år utan barn", "ensamstående kvinnor med barn 0-24 år", "ensamstående män med barn 0-24 år", "sammanboende utan barn", "sammanboende med barn 0-24 år, 1 barn", "sammanboende med barn 0-24 år, 2 barn", "sammanboende med barn 0-24 år, 3+  barn", "övriga hushåll utan barn 0-24 år", "övriga hushåll med barn 0-24 år", "samtliga hushåll"
			boendeform_klartext = "*",			 #  NA = tas inte med i uttaget,  Finns: "småhus, äganderätt", "småhus, bostadsrätt", "småhus, hyresrätt", "flerbostadshus, bostadsrätt", "flerbostadshus, hyresrätt", "specialbostad", "övrigt boende", "uppgift saknas", "samtliga boendeformer"
			cont_klartext = "*",			 #  Finns: "Antal hushåll", "Andel hushåll"
			tid_koder = "*",			 # "*" = alla år eller månader, "9999" = senaste, finns: "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023"
			long_format = TRUE,			# TRUE = konvertera innehållsvariablerna i datasetet till long-format 
			wide_om_en_contvar = TRUE,			# TRUE = om man vill behålla wide-format om det bara finns en innehållsvariabel, FALSE om man vill konvertera till long-format även om det bara finns en innehållsvariabel
			output_mapp = NA,			# anges om man vill exportera en excelfil med uttaget, den mapp man vill spara excelfilen till
			excel_filnamn = "hushall.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # Skapad av: moepet den 06 november 2024
  # Senast uppdaterad: 06 november 2024
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__HE__HE0111__HE0111A/HushallT22/
  #
  # ====================================================================================================
  ...
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/HE/HE0111/HE0111A/HushallT22"
  ...
  boendeform_vekt <- if (!all(is.na(boendeform_klartext))) hamta_kod_med_klartext(px_meta, boendeform_klartext, skickad_fran_variabel = "boendeform") else NA
  ...
  varlista <- list(
  	...
  	"Boendeform" = boendeform_vekt,
  	"ContentsCode" = cont_vekt,
  	"Tid" = tid_vekt)

  if (all(is.na(hushallstyp_klartext))) varlista <- varlista[names(varlista) != "Hushallstyp"]
  if (all(is.na(boendeform_klartext))) varlista <- varlista[names(varlista) != "Boendeform"]
