hamta_rmi_jobbinfloden_region_sni2007mi_kon_tid_scb <- function(
  ...
  #
  # Skapad av: moepet den 15 september 2024
  # Senast uppdaterad: 15 september 2024
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__AM__AM9906__AM9906A/RegionInd19E2B/
  #
  # ====================================================================================================
  ...
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/AM/AM9906/AM9906A/RegionInd19E2B"
  ...
  sni2007mi_vekt <- hamta_kod_med_klartext(px_meta, sni2007mi_klartext, skickad_fran_variabel = "sni2007mi")
