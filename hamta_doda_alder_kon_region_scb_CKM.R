hamta_doda_alder_kon_region_scb_CKM <- function(
			...
			excel_filnamn = "doda_SCB_CKM.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__BE__BE0101__BE0101I/DodaFodelsearKCKM/
  #
  # ====================================================================================================
  ...
  # Url till databas
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/BE/BE0101/BE0101I/DodaFodelsearKCKM"
  ...
  # Lägger till en distinct för att unvika dubbelräkning av olika slag
