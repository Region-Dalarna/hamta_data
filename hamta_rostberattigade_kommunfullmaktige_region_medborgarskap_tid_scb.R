hamta_rostberattigade_kommunfullmaktige_region_medborgarskap_tid_scb <- function(
			...
			cont_klartext = "*",			 #  Finns: "Kommunfullmäktigval - röstberättigade"
			...
			excel_filnamn = "rostberattigade_kommunfullmaktige.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__ME__ME0104__ME0104A/Kommunmed/
  #
  # ====================================================================================================
...
if (!require("pacman")) install.packages("pacman")
  ...
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/ME/ME0104/ME0104A/Kommunmed"
