hamta_folkmangd_civilstand_alder_kon_tid_CKM <- function(
			...
			civilstand_klartext = "*",			 #  Finns: "totalt, samtliga civilstånd", "ogifta", "gifta", "skilda", "änkor/änklingar"
			alder_koder = "*",			 #  Finns: t.ex. "0", "TotSA", "-4", "-9", "1", "2", "3", "4", "5", "5-9", "6", "7", "8", "9", "10-14", "10-19", "15-19", "20-24", "20-29", "25-29", "30-34", "30-39", "35-39", "40-44", "40-49", "45-49", "50-54", "50-59", "55-59", "60-64", "60-69", "65-69", "70-74", "70-79", "75-79", "80-84", "80-89", "85-89", "90-94", "90-99", "95-99", "98", "99", "100+1", "100+10", "100+5", "TOT1", "TOT10", "TOT5"
			...
			excel_filnamn = "bef_scb.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__BE__BE0101__BE0101A/BefolkningCKM/
  #
  # ====================================================================================================
  ...
  # Url till databas
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/BE/BE0101/BE0101A/BefolkningCKM"
  ...
  civilstand_vekt <- hamta_kod_med_klartext(px_meta, civilstand_klartext, skickad_fran_variabel = "civilstand")
