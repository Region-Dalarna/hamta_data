hamta_arbetsmarknadsstatus_bas_ar_prel <- function(
    ...
    excel_filnamn = "arbetsmarknadsstatus_bas_ar_slutgiltig.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  # Notera att preliminär data kan vara ofullständig och ändras i senare versioner. 
  # Använd därför även skriptet hamta_data_arbetsmarknadsstatus_bas_ar_slutgiltig.R för att hämta slutgiltig data där sådan finns tillgänglig.
