hamta_personbilar_region_agarkategori_tid_scb <- function(
  ...
  #
  # Skapad av: moepet den 05 maj 2025
  # Senast uppdaterad: 05 maj 2025
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__TK__TK1001__TK1001A/PersBilarA/
  #
  # ====================================================================================================
  ...
  agarkategori_vekt <- if (!all(is.na(agarkategori_klartext))) hamta_kod_med_klartext(px_meta, agarkategori_klartext, skickad_fran_variabel = "agarkategori") else NA
  ...
  varlista <- list(
  	"Region" = region_vekt,
  	"Agarkategori" = agarkategori_vekt,
  	"ContentsCode" = cont_vekt,
  	"Tid" = tid_vekt)

  if (all(is.na(agarkategori_klartext))) varlista <- varlista[names(varlista) != "Agarkategori"]
