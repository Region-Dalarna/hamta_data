...
hamta_konkurser_TVA <- function(
  ...
  # ====================================================================================================
  #
  # Skript för att hämta data över konkurser från Tillväxtanalys databas. 
  # För tillfället går det inte att hämta data över intervaller pga formatet 1996M01. Det går inte
  # heller att lägga med "9999" i intervallet. 
  # Skapad av: Jon den 26 september 2024
  #
  ...
  region_vekt <- hamta_kod_med_klartext(px_meta, region_klartext, skickad_fran_variabel = "län")
  variabel_vekt <- hamta_kod_med_klartext(px_meta, variabel_klartext, skickad_fran_variabel = "variabel")
  
  if(all(period_klartext == "9999")){
    period_vekt <- min(hamta_kod_med_klartext(px_meta, "*", skickad_fran_variabel = "månad"))
  } else{
    period_vekt <- hamta_kod_med_klartext(px_meta, period_klartext, skickad_fran_variabel = "månad")
  }
