hamta_integration_region_kon_bakgrund_tid_scb <- function(
			...
			bakgrund_klartext = "*",			 #  Finns: "andel 0-19 år, procent", "andel 20-64 år, procent", "andel 65+ år, procent", "samtliga utbildningsnivåer, procent", "andel med förgymnasial utbildning, procent", "andel med gymnasial utbildning, procent", "andel med eftergymnasial utbildning, procent", "andel där uppgift saknas för utbildningsnivå, procent", "samtliga, procent"
  ...
  #
  # Skapad av: moepet den 17 oktober 2024
  # Senast uppdaterad: 17 oktober 2024
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__AA__AA0003__AA0003E/IntGr3LanKONS/
  #
  # ====================================================================================================
  ...
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/AA/AA0003/AA0003E/IntGr3LanKONS"
