hamta_helarsekvivalenter_region_kon_aldersgrupp_tid_scb <- function(
			region_vekt = "00",			# Val av region.
			kon_klartext = "*",			 #  NA = tas inte med i uttaget,  Finns: "män", "kvinnor", "män och kvinnor totalt"
			aldersgrupp_klartext = "*",			 #  Finns: "20-64 år", "20-65 år"
			cont_klartext = "*",			 #  Finns: "Sjukpenning", "Sjuk- och aktivitetsersersättning", "Arbetslöshetsersättning", "Arbetsmarknadsåtgärder", "Ekonomiskt bistånd", "Etableringsersättning", "Summa helårsekvivalenter", "Folkmängd", "Andel av befolkningen"
