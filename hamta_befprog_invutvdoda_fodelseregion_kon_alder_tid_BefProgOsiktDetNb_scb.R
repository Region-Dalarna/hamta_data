hamta_befprog_invutvdoda_fodelseregion_kon_alder_tid_scb <- function(
			fodelseregion_klartext = "*",			#  NA = tas inte med i uttaget,  Finns: "födda i Sverige", "födda i Norden eller EU utom Sverige", "födda i Afrika", "födda i Asien", "födda i Europa utom Norden och EU samt Sydamerika, Nordamerika och Oceanien"
			...
			cont_klartext = "*",			 #  Finns: "Folkmängd", "Döda", "Inflyttade", "Utflyttade", "Medelfolkmängd"
			...
			excel_filnamn = "befprog_invutvdoda.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # url till tabellens API: https://api.scb.se/OV0104/v1/doris/sv/ssd/START/BE/BE0401/BE0401A/BefProgOsiktDetNb
  #
  # ====================================================================================================
  ...
  # Url till databas
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/BE/BE0401/BE0401A/BefProgOsiktDetNb"
