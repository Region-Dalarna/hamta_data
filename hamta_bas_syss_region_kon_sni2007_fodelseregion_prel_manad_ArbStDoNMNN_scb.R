hamta_bas_syss_region_kon_sni2007_fodelseregion_prel_manad_scb <- function(
  ...
  #
  # Skapad av: moepet den 21 augusti 2024
  # Senast uppdaterad: 21 augusti 2024
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__AM__AM0210__AM0210B/ArbStDoNMNN/
  #
  # ====================================================================================================
  ...
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/AM/AM0210/AM0210B/ArbStDoNMNN"
  ...
  var_vektor <- c(regionkod = "Region", sni2007kod = "SNI2007")
