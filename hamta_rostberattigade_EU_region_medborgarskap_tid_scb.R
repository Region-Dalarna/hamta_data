hamta_rostberattigade_EU_region_medborgarskap_tid_scb <- function(
			...
			cont_klartext = "*",			 #  Finns: "Europaparlamentsval - röstberättigade"
			tid_koder = "*",			 # "*" = alla år eller månader, "9999" = senaste, finns: "1995", "1999", "2004", "2009", "2014", "2019"
			output_mapp = NA,			# anges om man vill exportera en excelfil med uttaget, den mapp man vill spara excelfilen till
			excel_filnamn = "rostberattigade_EU.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__ME__ME0109__ME0109B/EUmed/
  #
  # ====================================================================================================
...
if (!require("pacman")) install.packages("pacman")
  ...
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/ME/ME0109/ME0109B/EUmed"
