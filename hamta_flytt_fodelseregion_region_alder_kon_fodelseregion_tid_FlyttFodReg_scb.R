hamta_flytt_fodelseregion_region_alder_kon_fodelseregion_tid_scb <- function(
			...
			cont_klartext = "*",			 #  Finns: "Samtliga inflyttningar", "Samtliga utflyttningar", "Inflyttningar från kommuner inom länet", "Inflyttningar från övriga län", "Utflyttningar till kommuner inom länet", "Utflyttningar till övriga län", "Utrikes inflyttningar", "Utrikes utflyttningar", "Flyttningsnetto, totalt", "Flyttningsnetto, eget län", "Flyttningsnetto, övriga län", "Flyttningsnetto, utlandet"
			...
			excel_filnamn = "flytt_fodelseregion.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__BE__BE0101__BE0101J/FlyttFodReg/
  #
  # ====================================================================================================
  ...
  # Url till databas
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/BE/BE0101/BE0101J/FlyttFodReg"
