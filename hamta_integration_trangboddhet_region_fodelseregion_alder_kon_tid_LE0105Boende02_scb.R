hamta_integration_trangboddhet_region_trangboddhet_fodelseregion_alder_kon_tid_scb <- function(
    ...
    trangboddhet_klartext = "*",			 #  NA = tas inte med i uttaget,  Finns: "totalt", "trångbodda enligt norm 2", "ej trångbodda enligt norm 2", "uppgift saknas"
    fodelseregion_klartext = "*",			#  NA = tas inte med i uttaget,  Finns: "totalt", "Europa exkl.Sverige", "Afrika", "Asien", "övriga världen, inkl. Sovjetunionen", "Sverige", "okänt"
    alder_klartext = "*",			 #  NA = tas inte med i uttaget,  Finns: "0-4 år", "0-4 år", "5-9 år", "5-14 år", "10-14 år", "15-19 år", "15-24 år", "20-24 år", "25-29 år", "25-34 år", "30-34 år", "35-39 år", "35-44 år", "40-44 år", "45-49 år", "45-54 år", "50-54 år", "55-59 år", "55-64 år", "60-64 år", "65-69 år", "65-74 år", "70-74 år", "75-79 år", "75-84 år", "80-84 år", "85-89 år", "85-94 år", "90-94 år", "95-99 år", "95+ år", "100+ år", "totalt"
    kon_klartext = "*",			 #  Finns: "totalt", "kvinnor", "män"
    cont_klartext = "*",			 #  Finns: "Samtliga i populationen", "Personer 0-17 år", "Personer minst 18 år"
    ...
    excel_filnamn = "integration_trangboddhet.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # Skapad av: frkjon den 26 mars 2025
  # Senast uppdaterad: 26 mars 2025
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__LE__LE0105__LE0105B/LE0105Boende02/
  #
  # ====================================================================================================
  ...
  # Url till databas
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/LE/LE0105/LE0105B/LE0105Boende02"
  ...
  trangboddhet_vekt <- if (!all(is.na(trangboddhet_klartext))) hamta_kod_med_klartext(px_meta, trangboddhet_klartext, skickad_fran_variabel = "trangboddhet") else NA
  ...
  varlista <- list(
    "Region" = region_vekt,
    "Trangboddhet" = trangboddhet_vekt,
  ...
  if (all(is.na(trangboddhet_klartext))) varlista <- varlista[names(varlista) != "Trangboddhet"]
