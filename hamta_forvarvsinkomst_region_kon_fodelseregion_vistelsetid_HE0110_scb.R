hamta_forvarvsinkomst_region_kon_fodelseregion_vistelsetid_scb <- function(
    ...
    fodelseregion_klartext = "*",			#  Finns: "samtliga", "födda i Sverige", "utrikes födda", "Norden exklusive Sverige", "EU exkl. Norden", "Europa exkl. EU och Norden", "Afrika", "Nordamerika", "Sydamerika", "Asien", "Oceanien"
    vistelsetiduf_klartext = "*",			 #  Finns: "samtliga", "1-2 år i Sverige", "3-4 år i Sverige", "5-9 år i Sverige", "10-19 år i Sverige", "20- år i Sverige"
    alder_klartext = "*",			 #  Finns: "20+ år", "20-64 år", "20-65 år", "65+ år", "66+ år"
    cont_klartext = "*",			 #  Finns: "Medelinkomst, tkr", "Medianinkomst, tkr", "Totalsumma, mnkr", "Antal personer"
  ...
  #
  # Skapad av: frkjon den 17 mars 2025
  # Senast uppdaterad: 17 mars 2025
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__HE__HE0110__HE0110A/SamForvInk3/
  #
  # ====================================================================================================
  ...
  # Url till databas
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/HE/HE0110/HE0110A/SamForvInk3"
  ...
  vistelsetiduf_vekt <- hamta_kod_med_klartext(px_meta, vistelsetiduf_klartext, skickad_fran_variabel = "vistelsetiduf")
  ...
  varlista <- list(
    ...
    "VistelsetidUF" = vistelsetiduf_vekt,
    "Alder" = alder_vekt,
