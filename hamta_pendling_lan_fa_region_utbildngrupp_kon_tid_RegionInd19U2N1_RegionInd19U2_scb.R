hamta_pendling_lan_fa_region_utbildngrupp_kon_tid_scb <- function(
			...
			excel_filnamn = "pendling_lan.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__AM__AM9906__AM9906B/RegionInd19U2N1/
  #												https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__AM__AM9906__AM9906O/RegionInd19U2/
  #
  # ====================================================================================================
  ...
  url_list <- c("https://api.scb.se/OV0104/v1/doris/sv/ssd/START/AM/AM9906/AM9906B/RegionInd19U2N1",
