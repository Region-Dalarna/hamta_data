hamta_bas_huvink_region_huvudfot1m_fat12m_kon_alder_fodelseregion_tid_scb <- function(
			...
			huvudfot1m_klartext = "*",			 #  Finns: "ersättning för arbete", "ersättning vid arbetslöshet", "ersättning för studier", "pension", "ersättning vid långvarigt nedsatt arbetsförmåga", "ersättning vid sjukdom", "ersättning vid föräldraledighet/närståendeomvårdnad", "ekonomiskt stöd", "saknar ersättningar"
			fat12m_klartext = "*",			 #  Finns: "0 kr", "1 kr -  < 1 inkomstbasbelopp", "1 -  < 2 inkomstbasbelopp", "2 -  < 3 inkomstbasbelopp", "3 inkomstbasbelopp eller mer"
			kon_klartext = "*",			 #  NA = tas inte med i uttaget,  Finns: "män", "kvinnor", "totalt"
			alder_klartext = "*",			 #  Finns: "15-19 år", "20-24 år", "25-54 år", "55-64 år", "65-74 år", "15-74 år", "16-64 år", "16-65 år", "20-64 år", "20-65 år"
			fodelseregion_klartext = "*",			#  NA = tas inte med i uttaget,  Finns: "inrikes född", "utrikes född", "totalt"
			cont_klartext = "*",			 #  Finns: "antal sysselsatta", "antal arbetslösa", "antal studerande", "antal pensionärer", "antal sjuka", "antal övriga", "antal totalt"
			...
			excel_filnamn = "bas_huvink.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # Skapad av: moepet den 20 november 2024
  # Senast uppdaterad: 20 november 2024
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__AM__AM0210__AM0210A/ArbStatHuv/
  #
  # ====================================================================================================
  ...
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/AM/AM0210/AM0210A/ArbStatHuv"
  ...
  huvudfot1m_vekt <- hamta_kod_med_klartext(px_meta, huvudfot1m_klartext, skickad_fran_variabel = "huvudfot1m")
  fat12m_vekt <- hamta_kod_med_klartext(px_meta, fat12m_klartext, skickad_fran_variabel = "fat12m")
